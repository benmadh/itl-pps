...
class CreateRunningWasteRotariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('running_waste_rotaries', function (Blueprint $table) {
            $table->increments('id'); 
    ...
    {
        Schema::dropIfExists('running_waste_rotaries');
    }
}
