...
class PartPrintingRotaryController extends Controller
{
    ...
    public function index(){       
        ...
        $save_msg=null;       
        $dep_ids=array('12');         
        $title="Update Print Quantity for PFL Rotary (Part)";
        ...
        return view('rotary.partprinting.partprinting')->with($params);
    }
    ...
    public function store(Request $request){
        ...
        if ($workorderheaders==null) { 
           return view('rotary.partprinting.partprinting')->with($params)->withErrors($validator);
        }
        if ($plData==null) { 
           return view('rotary.partprinting.partprinting')->with($params)->withErrors($validator);
        }
                      ...
                      $bal_prd_qty=0;
                        ...
                        if($quantity!=0){
                            ...
                            if($producedQtySize>=$woQtySize){
                                ...
                                $tracking_des="Part printing completed for size (".$size_id."), quantity is : ".$quantity."(". $woQtySize.") Machine : ".$machineDetails->machin_number." Operator : ".$operaterDetails->full_name." ( EPF # ".$operaterDetails->epf_no." )";
                            } 
