...
class CuttingRotaryController extends Controller
{
    ...
    public function index(){       
        ...
        $save_msg=null;       
        $dep_ids=array('12');         
        $title="Update Cutting Quantity for PFL Rotary (Complete)";
        ...
        return view('rotary.cutting.cutting')->with($params);
    }
    ...
    public function getCuttingDetailsRotary(){ 
