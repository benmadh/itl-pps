...
class PackingScreenController extends Controller
{
    use UtilityHelperGeneral;
    public function __construct(){
        $this->middleware('permission:packing_screen_access_allow');
    }  
    ...
    public function index(){   
        ...
        $save_msg=null;       
        $dep_ids=array('13');         
        $title="Update Packing Quantity for Screen (Complete)";
        ...
        return view('screen.packing.packing')->with($params);
    }
    ...
    public function store(Request $request){
        ...
        if ($workorderheaders==null) { 
           return view('screen.packing.packing')->with($params)->withErrors($validator);
        }
        if ($plData==null) { 
           return view('screen.packing.packing')->with($params)->withErrors($validator);
        }
    ...
    public function getPackingDetailsScreen(){ 
