...
class PrintingScreenController extends Controller
{
    ...
    public function index(){       
        ...
        $save_msg=null;       
        $dep_ids=array('13');         
        $title="Update Print Quantity for Screen (Complete)";
        ...
        return view('screen.printing.printing')->with($params);
    }
    ...
    public function getPrintingDetailsScreen(){ 
