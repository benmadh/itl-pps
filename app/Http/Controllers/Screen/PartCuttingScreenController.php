...
class PartCuttingScreenController extends Controller
{
    ...
    public function index(){       
        ...
        $save_msg=null;       
        $dep_ids=array('13');         
        $title="Update Cutting Quantity for Screen (Part)";
        ...
        return view('screen.partcutting.partcutting')->with($params);
    }
    ...
    public function store(Request $request){
        ...
        if ($workorderheaders==null) { 
           return view('screen.partcutting.partcutting')->with($params)->withErrors($validator);
        }
        if ($plData==null) { 
           return view('screen.partcutting.partcutting')->with($params)->withErrors($validator);
        }
