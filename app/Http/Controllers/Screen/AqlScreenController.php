...
class AqlScreenController extends Controller
{
    use UtilityHelperGeneral;
    public function __construct(){
        $this->middleware('permission:aql_screen_access_allow');
    }  
    ...
    public function index(){   
        ...
        $save_msg=null;       
        $dep_ids=array('13');         
        $title="Update AQL Quantity for Screen (Complete)";
        ...
        return view('screen.aqls.aqls')->with($params);
    }
    ...
    public function store(Request $request){
        ...
        if ($workorderheaders==null) { 
           return view('screen.aqls.aqls')->with($params)->withErrors($validator);
        }
        if ($plData==null) { 
           return view('screen.aqls.aqls')->with($params)->withErrors($validator);
        }
    ...
    public function getAqlDetailsScreen(){ 
