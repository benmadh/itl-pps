...
class OrdTrcPltController extends Controller
{
    use UtilityHelperGeneral;
    public function __construct(){
        // $this->middleware('permission:order_tracking_plate_room_access_allow');
    } 
    ...
    public function index(){  
        ...
        $save_msg=null; 
        $params = [
            'title' => 'Scan Work Orders for Plate Room',          
        ];
        return view('general.ordtrcplt.ordtrcplt')->with($params);       
    }
