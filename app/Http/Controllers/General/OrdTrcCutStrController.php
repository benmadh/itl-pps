...
class OrdTrcCutStrController extends Controller
{
    use UtilityHelperGeneral;
    public function __construct(){
        $this->middleware('permission:order_tracking_cut_str_access_allow');
    } 
    ...
    public function index(){  
        ...
        $save_msg=null; 
        $params = [
            'title' => 'Scan Work Orders - Cutting Start',          
        ];
        return view('general.ordtrccutstr.ordtrccutstr')->with($params);       
    }
