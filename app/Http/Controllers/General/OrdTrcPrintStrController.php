...
class OrdTrcPrintStrController extends Controller
{
    use UtilityHelperGeneral;
    public function __construct(){
        $this->middleware('permission:order_tracking_print_str_access_allow');
    } 
    ...
    public function index(){  
        ...
        $save_msg=null; 
        $params = [
            'title' => 'Scan Work Orders - Printing Start',          
        ];
        return view('general.ordtrcprtstr.ordtrcprtstr')->with($params);       
    }
