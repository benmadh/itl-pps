    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('daytypes.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('colorpicker_id') ? ' has-error' : '' }}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="colorpicker_id">@lang('general.common.colorpicker_id') <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input style="height:40px;font-size:14pt;" type="text" value="#ffffff" id="colorpicker_id" name="colorpicker_id" class="form-control input-lg">
