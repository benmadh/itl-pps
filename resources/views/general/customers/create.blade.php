                    ...
                    <form method="post" action="{{ route('customers.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('account_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('account_code') ?: '' }}" id="account_code" name="account_code" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('adress_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('adress_1') ?: '' }}" id="adress_1" name="adress_1" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('adress_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('adress_2') ?: '' }}" id="adress_2" name="adress_2" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('city') ?: '' }}" id="city" name="city" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('city'))
                        ...
                        <div class="form-group{{ $errors->has('telephone_land') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('telephone_land') ?: '' }}" id="telephone_land" name="telephone_land" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('telephone_fax') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('telephone_fax') ?: '' }}" id="telephone_fax" name="telephone_fax" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('official_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ Request::old('official_email') ?: '' }}" id="official_email" name="official_email" class="form-control col-md-7 col-xs-12">
