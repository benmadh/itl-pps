        ...
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{ route('holidays.destroy', ['id' => $dataObj->id]) }}">
                        <input type="hidden" name="_token" value="{{ Session::token() }}">
                        <input name="_method" type="hidden" value="DELETE">
                        <button type="submit" class="btn btn-danger">@lang('general.form.delete') <strong>{{$dataObj->date}}</strong></button>
                    </form>
                </div>
            </div>
        </div>
