    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-11 col-sm-11 col-xs-11">
                            <h2>@lang('labelreferences.edit')</h2>
                        </div>
                ...
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('labelreferences.update', ['id' => $dataObj->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row"> 
                            <div class ="col-md-7">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">@lang('general.common.description')</label>
                                    <div class="col-md-8 col-sm-8 col-xs-8">
                                        <input type="text" value="{{$dataObj->description}}" id="description" name="description" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('ground_colour') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{ $dataObj->ground_colour }}" id="ground_colour" name="ground_colour" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('print_colour') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{ $dataObj->print_colour }}" id="print_colour" name="print_colour" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('combo') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{ $dataObj->combo }}" id="combo" name="combo" class="form-control col-md-7 col-xs-12">
                                        @if ($errors->has('combo'))
                                ...
                                <div class="form-group{{ $errors->has('default_lenght') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{ $dataObj->default_lenght }}" id="default_lenght" name="default_lenght" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('default_width') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{ $dataObj->default_width }}" id="default_width" name="default_width" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <select class="js-example-basic-single form-control" id="chain_id" name="chain_id">
                                            @if(count($chainsData))                                        
                                                @foreach($chainsData as $rowChainsData)
                                                      <option value="{{$rowChainsData->id}}" {{ $rowChainsData->id == $dataObj->chain_id ? 'selected="selected"' : ''}}> {{$rowChainsData->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>  
                                        ...
                                        <select class="js-example-basic-single form-control" id="labeltype_id" name="labeltype_id">
                                            @if(count($labelTypeData))                                        
                                                @foreach($labelTypeData as $rowLabelTypeData)                                                      
                                                      <option value="{{$rowLabelTypeData->id}}" {{ $rowLabelTypeData->id == $dataObj->labeltype_id ? 'selected="selected"' : ''}}> {{$rowLabelTypeData->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>  
                                        ...
                                        <select class="js-example-basic-single form-control" id="department_id" name="department_id">
                                            @if(count($deptData))                                        
                                                @foreach($deptData as $rowDeptData)                                                     
                                                      <option value="{{$rowDeptData->id}}" {{ $rowDeptData->id == $dataObj->department_id ? 'selected="selected"' : ''}}> {{$rowDeptData->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>  
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-3" for="picture">Upload File 
                                    </label>                                                
                                    <div class="col-md-8 col-sm-8 col-xs-8">                                          
