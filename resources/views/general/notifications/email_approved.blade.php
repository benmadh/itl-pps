                    ...
                    <tr>
                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                ...
                                @if($mail_method == 2)
                                    ...
                                    <?php
                                       $actionColorYes = 'button--green';
                                      
                                    ?>
                                    @if($system_access != null)
                                      <a href="{{ route('visitorrequestsecondapproval.edit', ['id' => $visitorrequestid]) }}"
                                          style="{{ $fontFamily }} {{ $style['button'] }} {{ $style[$actionColorYes] }}"
                                          class="button"
                                          target="_blank">
                                          &nbsp;&nbsp;&nbsp;{{ $system_access }}&nbsp;&nbsp;&nbsp;
                                      </a> 
                                                  ...
                                                  @if (count($linedetails))
                                                   ...
                                                   <tr>
                                                    <td colspan="3"> 
                                                        ...
                                                        @if($mail_method == 1)
                                                           @if($system_access != null)
                                                              <a href="{{ route('visitorrequestfirstapproval.edit', ['id' => $visitorrequestid]) }}"
                                                                  style="{{ $fontFamily }} {{ $style['button'] }} {{ $style[$actionColorYes] }}"
                                                                  class="button"
                                                                  target="_blank">
                                                                  &nbsp;&nbsp;&nbsp;System Access&nbsp;&nbsp;&nbsp;
