        ...
        <div class="form-group">
            <div  class="row">               
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endpermission
                     @permission(('printing_screen_access_allow'))
                        <div class="col-lg-2 col-sm-4 col-xs-4">
                            <div class="small-box bg-teal">
                                ...
                                <a href="{{route('printingScreen.index')}}" class="small-box-footer btn {{ Auth::user()->can('printing_screen_access_allow') ? 'active' : 'disabled' }}">
                                    Go <i class="fa fa-arrow-circle-right"></i>
                                </a>                        
                            </div>
                        </div>
                    ...
                    @permission(('cutting_screen_access_allow'))
                        <div class="col-lg-2 col-sm-4 col-xs-6">
                            <div class="small-box bg-teal">
                                ...
                                <a href="{{route('cuttingScreen.index')}}" class="small-box-footer btn {{ Auth::user()->can('cutting_screen_access_allow') ? 'active' : 'disabled' }}">
                                    Go <i class="fa fa-arrow-circle-right"></i>
                                </a>                        
                            </div>
                        </div>
            ...
            <div  class="row"> 
            <div class="col-md-12 col-sm-12 col-xs-12">
                @permission(('packing_screen_access_allow'))
                    <div class="col-lg-2 col-sm-4 col-xs-4">
                        <div class="small-box bg-gray">
                            <div class="inner">
                                <h3>Packing </h3>
                            ...
                            <a href="{{route('packingScreen.index')}}" class="small-box-footer btn {{ Auth::user()->can('packing_screen_access_allow') ? 'active' : 'disabled' }}">
                                Go <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                @permission(('aql_screen_access_allow'))
                    <div class="col-lg-2 col-sm-4 col-xs-4">
                        <div class="small-box bg-teal">
                            <div class="inner">
                                <h3>AQL </h3>
                            ...
                            <a href="{{route('aqlScreen.index')}}" class="small-box-footer btn {{ Auth::user()->can('aql_screen_access_allow') ? 'active' : 'disabled' }}">
                                Go <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                @endpermission 
                 @permission(('mrn_screen_access_allow'))
                    <div class="col-lg-2 col-sm-4 col-xs-4">
                        <div class="small-box bg-olive">
                            <div class="inner">
                                <h3>MRN </h3>
                            ...
                            <a href="{{route('mrnScreen.index')}}" class="small-box-footer btn {{ Auth::user()->can('mrn_screen_access_allow') ? 'active' : 'disabled' }}">
                                Go <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
