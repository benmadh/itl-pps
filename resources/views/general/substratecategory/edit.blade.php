    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-11 col-sm-11 col-xs-11">
                            <h2>@lang('substrateCategory.edit')</h2>
                        </div>
                ...
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('substratecategories.update', ['id' => $dataObj->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
