    ...
    <div class="">        
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                 @include('general.templates.quck_link_pfl_rotary')
                <div class="x_panel">
                    <div class="x_title">                     
                        <h2>Dash Board - PFL Rotary</h2>
                        <div class="clearfix"></div>
                    </div>

                    <div class="x_content">
                        <br />
                        <form method="post" action="{{ route('dbRotary.chartDetails') }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                               <div class="row">
                                    <div class ="col-md-4">
                                        <div class="x_panel">
