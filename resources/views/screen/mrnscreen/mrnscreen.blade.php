                                        ...
                                        @if (count($dataLst))                               
                                            @foreach($dataLst as $row)
                                                <tr>                               
                                                    ...
                                                    <td>{{$row->work_order_headers->lenght}}</td> 
                                                    <td>{{$row->work_order_headers->no_of_colors_front}}</td> 
                                                    <td>{{$row->work_order_headers->no_of_colors_back}}</td> 
                                                    <td>{{$row->work_order_headers->size_changes}}</td>                                                 
