    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-11 col-sm-11 col-xs-11">
                            <h2>Edit PFL Screen Rate File</h2>
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-1">
                            <h2> <a href="{{route('scrratefile.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> @lang('general.nav.back') </a></h2>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('scrratefile.update', ['id' => $dataObj->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="x_panel">
                                            ...
                                            <select class="js-example-basic-single form-control" id="company_id" name="company_id" onchange="getLocationList()">
                                                ...
                                                <option value=""></option>                                       
                                                    @foreach($comData as $row)
                                                        <option value="{{$row->id}}" {{ $row->id == $dataObj->company_id ? 'selected="selected"' : ''}}> {{$row->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>  
                                            ...
                                            <select class="form-control" id="location_id" name="location_id">
                                                ...
                                                <option value=""></option>                                       
                                                    @foreach($locData as $row)
                                                        <option value="{{$row->id}}" {{ $row->id == $dataObj->location_id ? 'selected="selected"' : ''}}> {{$row->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>  
                                            ...
                                            <select class="js-example-basic-single form-control" id="machine_type_id" name="machine_type_id">
                                                @if(count($mctData))                                        
                                                    @foreach($mctData as $row)                                                        
                                                        <option value="{{$row->id}}" {{ $row->id == $dataObj->machine_type_id ? 'selected="selected"' : ''}}> {{$row->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>  
                                ...
                                <div class ="col-md-3">
                                    <div class="form-group{{ $errors->has('table_type') ? ' has-error' : '' }}">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-4" for="table_type">@lang('general.common.table_type')  <span class="required">*</span>
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-7">
                                            <select class="js-example-basic-single form-control" id="table_type" name="table_type">
                                                @if(count($tableTypeLst))                                        
                                                    @foreach($tableTypeLst as $row)
                                                        <option value="{{$row}}" {{$row == $dataObj->table_type ? 'selected="selected"' : ''}}>{{$row}}</option>
                                                    @endforeach
                                                @endif
                                            </select>  
                        ...
                        <div class="row">
                            <div class="x_panel">
                                <div class ="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('each_clr_front_waste_mtr') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->each_clr_front_waste_mtr }}" id="each_clr_front_waste_mtr" name="each_clr_front_waste_mtr" class="decimal form-control text-right" >
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('each_clr_front_setup_time_min') ? ' has-error' : '' }}"> 
                                                <input type="text" value="{{ $dataObj->each_clr_front_setup_time_min }}" id="each_clr_front_setup_time_min" name="each_clr_front_setup_time_min" class="integer form-control text-right">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('each_clr_back_waste_mtr') ? ' has-error' : '' }}">                                           
                                                <input type="text" value="{{ $dataObj->each_clr_back_waste_mtr }}" id="each_clr_back_waste_mtr" name="each_clr_back_waste_mtr" class="decimal form-control text-right" >
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('each_clr_back_setup_time_min') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->each_clr_back_setup_time_min }}" id="each_clr_back_setup_time_min" name="each_clr_back_setup_time_min" class="integer form-control text-right" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('plate_change_waste_mtr') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->plate_change_waste_mtr }}" id="plate_change_waste_mtr" name="plate_change_waste_mtr" class="decimal form-control text-right">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('plate_change_setup_time_min') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->plate_change_setup_time_min }}" id="plate_change_setup_time_min" name="plate_change_setup_time_min" class="integer form-control text-right">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('tape_setup_waste_mtr') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->tape_setup_waste_mtr }}" id="tape_setup_waste_mtr" name="tape_setup_waste_mtr" class="decimal form-control text-right">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('tape_setup_setup_time_min') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->tape_setup_setup_time_min  }}" id="tape_setup_setup_time_min" name="tape_setup_setup_time_min" class="integer form-control text-right">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class ="col-md-3">
                                            <div class="form-group{{ $errors->has('reference_change_time_min') ? ' has-error' : '' }}">
                                                <input type="text" value="{{ $dataObj->reference_change_time_min }}" id="reference_change_time_min" name="reference_change_time_min" class="integer form-control text-right">
                                   ...
                                   <div class="row">
                                        <div class ="col-md-5">
                                            <label>@lang('general.common.isActive')   </label>
                                        </div>
                                        <div class ="col-md-3">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="form-group">
                                            <table class="table table-bordered" id="table_cutting_method" >
                                                ...
                                                <tbody>
                                                    @if (count($dataObj->cuttingWasteRotaries)) 
                                                        @foreach($dataObj->cuttingWasteRotaries as $row)
                                                            <tr> 
                                                                <td>
                                                                    <input type="hidden" value="{{ $row->id }}" id="cutting_waste_id" name="cutting_waste_id[]" >
                                                                    <input type="hidden" value="{{ $row->cutting_methods_id }}" id="cm_id{{$loop->index}}" name="cm_id[]" >
                                                                    <input type="text" value="{{$row->cuttingMethods->name}}" name="cm_name[]" class="form-control text-right cm_name" id="cm_name{{$loop->index}}" disabled>
                                                                </td>  
                                                                <td>
                                                                    <input type="text" value="{{$row->pcs}}" name="pcs[]" class="integer form-control text-right pcs" id="pcs{{$loop->index}}" >
                                                                </td>     
                                                            </tr>
                                                        @endforeach
                                                    @else                                                        
                                                        @foreach($cuttingMethodData as $row)
                                                            <tr> 
                                                                ...
                                                                <td>
                                                                    <input type="text" id="pcs{{$loop->index}}" name="pcs[]" class="integer form-control text-right pcs">
                                                                </td>     
                                                            </tr>
                                                        @endforeach                                                       
                                                    @endif 
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="form-group">
                                            <table class="table table-bordered" id="table_bom" >
                                                ...
                                                <tbody>
                                                    @if (count($dataObj->additionsCusRotaries)) 
                                                        @foreach($dataObj->additionsCusRotaries as $row)
                                                            <tr> 
                                                                <td>
                                                                    <input type="hidden" value="{{ $row->id }}" id="additions_to_cus_id" name="additions_to_cus_id[]" >
                                                                    <input type="text" value="{{$row->from_ord_qty}}" name="from_ord_qty[]" class="integer form-control text-right from_ord_qty" id="from_ord_qty{{$loop->index}}" >
                                                                </td>  
                                                                <td>
                                                                    <input type="text" value="{{$row->to_ord_qty}}" name="to_ord_qty[]" class="integer form-control text-right to_ord_qty" id="to_ord_qty{{$loop->index}}" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" value="{{$row->percentage}}" name="percentage[]" class="decimal form-control text-right percentage" id="percentage{{$loop->index}}" >
                                                                </td>
                                                                <td>
            ...
            $('#addRowRw').click(function(){            
             ...
             $('#addRowMs').click(function(){            
                ...
                $('#table_machine_speed').append('<tr i="row'+i+'">'+             
                                        ...
                                        '</td>'+
                                        '@foreach($substrateCategoryData as $rowMs)'+ 
                                        '<td>'+
                                        '<input type="text" name="{{$rowMs->id}}[]" id="{{$rowMs->id}}'+i+'" class="decimal form-control text-right">'+
                                        '</td>'+
                                        '@endforeach'+ 
                                        '<td>'+
                                        '<button type="button" name="btn_remove" id="btn_remove" class="btn btn-danger btn_remove">X</button>'+
